...
```{r select-vars, warning=FALSE, echo=TRUE}
...
```{r mva-vs-rec, message=FALSE, echo=TRUE}
...
```
### Comparison Plots
```{r var-vs-rec-plot, fig.height=5, fig.width=9, warning=FALSE, cache=FALSE}
...
```{r logisitic-regression-code, echo=TRUE}
...
#### Decision Tree
```{r decision-tree-code, echo=TRUE}
...
#### Random Forest
```{r random-forest-code, echo=TRUE}
...
#### Cross Validation
```{r cross-validation-code, echo=TRUE}
...
#### Threshold Analytics
```{r threshold-analysis-code, echo=TRUE}
...
```{r model-selection, warning=F, echo=TRUE}
...
```{r cross-validation, warning=FALSE, cache=FALSE}
...
```{r threshold-analysis, fig.width=7, fig.height=5, warning=FALSE, cache=FALSE}
...
##### Ensemble
```{r ensemble, cache=FALSE, echo=TRUE}
...
```{r decision-tree, fig.width=9, fig.height=6, cache=FALSE, echo=TRUE}
m <- dt_train(
  recommendation_code ~ ., 
  dat=dat, cutoff=.4, 
...
```{r bootstrap-predictions-code, cache=FALSE, warning=FALSE, echo=TRUE}
...
```{r bootstrap-predictions-simple, cache=TRUE, echo=TRUE}
